defmodule Feedx.DataCase do
  ...
  by setting `use Feedx.DataCase, async: true`, although
  ...
  def setup_sandbox(tags) do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(Feedx.Repo, shared: not tags[:async])
