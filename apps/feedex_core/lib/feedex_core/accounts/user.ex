defmodule FeedexCore.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, FeedexCore.Repo)
  ...
  """
  def valid_password?(%FeedexCore.Accounts.User{pwd_hash: hashed_password}, password)
